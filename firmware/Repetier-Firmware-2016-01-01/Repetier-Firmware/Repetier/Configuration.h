...
#define UI_PRINTER_NAME "i3 2XZ+"
#define UI_PRINTER_COMPANY "RepRap.ir"
...
========== Start configuration string ==========
{
    ...
    "uiPrinterName": "i3 2XZ+",
    "uiPrinterCompany": "RepRap.ir",
